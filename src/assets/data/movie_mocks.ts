export const movie_mocks = [
  ...
  },
  {
    ...
    writers: ['Jean C. Havez (story)', 'Clyde Bruckman (story)', 'Joseph A. Mitchell (story)'],
  ...
  },
  {
    ...
    writers: ['Victor Hugo', 'Perley Poore Sheehan (adaptation)', 'Edward T. Lowe Jr. (scenario)'],
    awards: [{ wins: 1, nominations: 0, text: '1 win.' }],
  ...
  },
  {
    ...
    cast: ['John Gilbert', 'Renèe Adorèe', 'Hobart Bosworth', 'Claire McDowell'],
    languages: [],
    ...
    num_mflix_comments: 1,
    writers: ['Laurence Stallings (story)', 'Harry Behn (scenario)', 'Joseph Farnham (titles)'],
  ...
  },
  {
    ...
    genres: ['Horror'],
    cast: ['Max Schreck', 'Gustav von Wangenheim', 'Greta Schrèder', 'Georg H. Schnell'],
    languages: ['German'],
  ...
  },
  {
    ...
    writers: ['Clyde Bruckman (story)', 'Joseph A. Mitchell (story)', 'Jean C. Havez (story)'],
    awards: [{ wins: 0, nominations: 1, text: '1 nomination.' }],
  ...
  },
  {
    ...
    writers: ['Winsor McCay (comic strip "Little Nemo in Slumberland")', 'Winsor McCay (screenplay)'],
    awards: [{ wins: 1, nominations: 0, text: '1 win.' }],
  ...
  },
  {
    ...
    cast: ['Harold Lloyd', 'Jobyna Ralston', 'Brooks Benedict', 'James Anderson'],
    languages: ['English'],
    ...
    writers: ['Sam Taylor (story)', 'Ted Wilde (story)', 'John Grey (story)', 'Tim Whelan (story)'],
    awards: [{ wins: 1, nominations: 0, text: '1 win.' }],
...
export default class movie_rocks {}
